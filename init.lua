...

  {
    ...
    opts = {
      ...
      on_attach = function(bufnr)
        ...
        map('n', '<leader>guc', gs.reset_buffer, {desc = 'undo all changes' })
...
-- [[ Basic Keymaps ]]
vim.keymap.set({'n','v'}, '<leader>ls', vim.cmd.Ex)
...
vim.keymap.set('n', 'fr', require('telescope.builtin').oldfiles, { desc = '[?] Find recently opened files' })
...
vim.defer_fn(function()
  require('nvim-treesitter.configs').setup {
    ...
    ensure_installed = { 'c', 'cpp', 'lua', 'python', 'rust', 'javascript', 'typescript', 'vimdoc', 'vim', 'bash', 'php' },
